...
| `npm run test:e2e` | the built extension loads in headless Chromium and the 19 Playwright tests in `test/e2e/` pass, eyedropper and clipboard included             | ~8s, 4 workers |
