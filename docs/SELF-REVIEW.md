...
e2e suite and 25 Vitest cases over the colour utilities. nas-stacks attached a real incident to every rule it could; this checklist does the
...
workers. `src/utils/color-utils.test.ts` is 25 Vitest cases since 17 September 2026
(`docs/TESTING.md`).
